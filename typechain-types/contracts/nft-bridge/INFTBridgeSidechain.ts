...
export interface INFTBridgeSidechainInterface extends utils.Interface {
	functions: {
...
export interface INFTBridgeSidechain extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this
	attach(addressOrName: string): this
	deployed(): Promise<this>

	interface: INFTBridgeSidechainInterface
