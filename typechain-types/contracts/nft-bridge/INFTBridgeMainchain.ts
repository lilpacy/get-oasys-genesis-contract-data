...
export interface INFTBridgeMainchainInterface extends utils.Interface {
	functions: {
...
export interface INFTBridgeMainchain extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this
	attach(addressOrName: string): this
	deployed(): Promise<this>

	interface: INFTBridgeMainchainInterface
