...
export interface IL2ERC721BridgeInterface extends utils.Interface {
	functions: {
	...
	getFunction(
		nameOrSignatureOrTopic: 'finalizeDeposit' | 'l1ERC721Bridge' | 'withdraw' | 'withdrawTo',
	): FunctionFragment
	...
	encodeFunctionData(functionFragment: 'l1ERC721Bridge', values?: undefined): string
	encodeFunctionData(
	...
	decodeFunctionResult(functionFragment: 'l1ERC721Bridge', data: BytesLike): Result
...
export interface IL2ERC721Bridge extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this
	attach(addressOrName: string): this
	deployed(): Promise<this>

	interface: IL2ERC721BridgeInterface
