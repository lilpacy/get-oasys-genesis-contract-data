...
export interface L1StandardERC721Interface extends utils.Interface {
	functions: {
	...
	decodeFunctionResult(functionFragment: 'setTokenURI(uint256,string)', data: BytesLike): Result
	decodeFunctionResult(
		functionFragment: 'setTokenURI(uint256[],string[])',
		data: BytesLike,
	): Result
...
export interface L1StandardERC721 extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this
	attach(addressOrName: string): this
	deployed(): Promise<this>

	interface: L1StandardERC721Interface
