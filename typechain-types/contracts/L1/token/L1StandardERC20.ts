...
export interface L1StandardERC20Interface extends utils.Interface {
	functions: {
...
export interface L1StandardERC20 extends BaseContract {
	connect(signerOrProvider: Signer | Provider | string): this
	attach(addressOrName: string): this
	deployed(): Promise<this>

	interface: L1StandardERC20Interface
