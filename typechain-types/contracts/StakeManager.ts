...
export interface StakeManagerInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'environment', values?: undefined): string
	encodeFunctionData(
	...
	encodeFunctionData(functionFragment: 'validators', values: [PromiseOrValue<string>]): string
	...
	decodeFunctionResult(functionFragment: 'environment', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'operatorToOwner', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'stakeUpdates', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'stakerSigners', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'validatorOwners', data: BytesLike): Result
...
export interface StakeManager extends BaseContract {
	...
	functions: {
		...
		getStakers(
			...
			howMany: PromiseOrValue<BigNumberish>,
			overrides?: CallOverrides,
		): Promise<[string[], BigNumber] & { _stakers: string[]; newCursor: BigNumber }>
		...
		operatorToOwner(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string]>
	...
	stakeAmounts(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>

	stakeUpdates(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>

	stakerSigners(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>

	stakers(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>
	...
	validatorOwners(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>
	...
	estimateGas: {
		...
		operatorToOwner(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
		...
		validators(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
	}
